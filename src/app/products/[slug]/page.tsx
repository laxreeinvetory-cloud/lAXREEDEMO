    ...
    fetch("/api/admin/products", { cache: "no-store" })
      ...
      .then((data) => {
        ...
        for (const child of children) {
          ...
          images[child.slug] = { image: withImage?.image || "/images/product-catalogue/coming-soon.jpg", count: childProducts.length };
        }
        ...
        for (const other of otherParents) {
          ...
          otherImgs[other.slug] = { image: withImage?.image || "/images/product-catalogue/coming-soon.jpg", count: otherProducts.length };
        }
