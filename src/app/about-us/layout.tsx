...
export const metadata: Metadata = {
  ...
  description: "LaxRee Amenities is an 11-year-old OEM manufacturer of hotel minibars, safe lockers, furniture, linen, roofing and dome structures. India's largest hospitality exhibition centre. 1,347+ projects delivered across 28 states.",
  ...
  openGraph: {
    ...
    description: "11+ years of manufacturing hotel minibars, safes, furniture. India's largest hospitality exhibition centre.",
