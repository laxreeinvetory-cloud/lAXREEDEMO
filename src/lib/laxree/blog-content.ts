  ...
  if (post.slug === "top-hotel-amenities-suppliers-india") {
    ...
    full.content = [
      ...
      },
      {
        ...
        paragraphs: [
          "LaxRee Amenities is one of India's few OEM manufacturers of hotel minibars and safe lockers. Founded in 2020 in Ajmer, Rajasthan, we operate our own factory lines and India's largest Hotel Supplier Experience Center (12,000 sq ft).",
